        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 xl:col-span-7">
            ...
            <div className="flex items-center gap-2 text-caption text-ink-500 mb-6">
              ...
              <span>/</span>
              <span className="text-brand-900 font-medium">Industries</span>
            </div>
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-100 border border-slate-200 text-badge text-slate-700 mb-4">
              ...
              <span className="font-mono uppercase font-medium">SECTOR SOLUTIONS</span>
            </div>

            {/* Main Headline (Strictly from WeServe.MD) */}
            <h1 className="text-2xl sm:text-3xl lg:text-h2 font-medium text-brand-900 tracking-tight leading-tight mb-3 max-w-2xl">
