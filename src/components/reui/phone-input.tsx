...
function InputComponent({
  ...
  return (
    <Input
      className={cn(
        "ring-none! rounded-s-none outline-none! focus:z-1 h-10 border-gray-200 text-sm bg-white",
        variant === "sm" &&
          "h-7",
        variant === "lg" &&
          "h-11",
      ...
      <ComboboxTrigger
        render={
          <Button
            ...
            size={variant}
            className={cn(
              "h-10 rounded-s-lg rounded-e-none flex items-center gap-1 border-gray-200 border-e-0 px-2.5 py-0 leading-none hover:bg-slate-50 focus:z-10 data-pressed:bg-transparent bg-slate-50/50",
              disabled && "opacity-50"
            )}
            disabled={disabled}
          >
