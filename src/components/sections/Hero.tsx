          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 lg:gap-6 items-center">
            ...
            <div className="md:col-span-4 flex flex-col relative">
              ...
              <div className="md:hidden flex justify-center py-1.5">
                <div className="w-[1.5px] h-6 bg-slate-300 border-l border-dashed border-slate-300" />
              </div>
            </div>

            {/* =================================================================== */}
            {/* 2. CENTER NODE: Architecture Core + Inputs + Pill + Verified Badges */}
            {/* =================================================================== */}
            <div className="md:col-span-4 flex flex-col relative">
              ...
              >
                ...
                <div className="hidden md:block absolute -left-4 lg:-left-6 top-1/2 -translate-y-1/2 w-4 lg:w-6 h-[1.5px] bg-slate-300 rounded-full z-10" />
                <div className="hidden md:block absolute -left-1.5 top-1/2 -translate-y-1/2 w-3 h-3 rounded-full bg-slate-400 ring-2 ring-white shadow-xs z-20" />

                {/* Left Branching Distributor Wires (from Left Edge to 3 Bubbles) */}
                <svg
                  className="hidden md:block absolute left-0 top-1/2 -translate-y-1/2 w-7 lg:w-8 h-[130px] pointer-events-none z-0"
                  viewBox="0 0 32 130"
                  fill="none"
                >
                ...
                <div className="hidden md:block absolute -right-1.5 top-1/2 -translate-y-1/2 w-3 h-3 rounded-full bg-teal-500 ring-2 ring-white shadow-xs z-20" />
                <div className="hidden md:block absolute -right-4 lg:-right-6 top-1/2 -translate-y-1/2 w-4 lg:w-6 h-[1.5px] bg-slate-300 rounded-full z-10" />
              </div>
            ...
            <div className="md:col-span-4 flex flex-col relative">
              ...
              <div className="bg-white rounded-2xl p-4 sm:p-5 border border-line shadow-lg shadow-brand-900/[0.03] hover:shadow-xl transition-all duration-300 relative h-[270px] flex flex-col justify-center">
                {/* Left Edge Terminal Dot receiving connection from Center Node */}
                ...
                <div className="relative w-full h-[200px]">
                  ...
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    {/* Incoming wire from left card edge to center hub */}
                    <line x1="0" y1="50%" x2="50%" y2="50%" stroke="#CBD5E1" strokeWidth="1.5" strokeDasharray="3 3" />

                    {/* Constellation rays from center hub (50%, 50%) to nodes */}
                    <line x1="50%" y1="50%" x2="20%" y2="18%" stroke="#CBD5E1" strokeWidth="1.2" strokeDasharray="3 3" />
                    <line x1="50%" y1="50%" x2="80%" y2="18%" stroke="#CBD5E1" strokeWidth="1.2" strokeDasharray="3 3" />
                    <line x1="50%" y1="50%" x2="16%" y2="82%" stroke="#CBD5E1" strokeWidth="1.2" strokeDasharray="3 3" />
                    <line x1="50%" y1="50%" x2="50%" y2="82%" stroke="#CBD5E1" strokeWidth="1.2" strokeDasharray="3 3" />
                    <line x1="50%" y1="50%" x2="84%" y2="82%" stroke="#CBD5E1" strokeWidth="1.2" strokeDasharray="3 3" />
                  </svg>

                  {/* Top Left: Architect */}
                  <div className="absolute left-[20%] top-[18%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-10 group cursor-pointer">
                    ...
                    <span className="text-caption text-ink-500 group-hover:text-brand-900 font-medium mt-1 transition-colors">Architect</span>
                  </div>

                  {/* Top Right: Full-Stack */}
                  <div className="absolute left-[80%] top-[18%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-10 group cursor-pointer">
                    ...
                    <span className="text-caption text-ink-500 group-hover:text-brand-900 font-medium mt-1 transition-colors">Full-Stack</span>
                  </div>
                  ...
                  <div className="absolute left-[16%] top-[82%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-10 group cursor-pointer">
                    ...
                    <span className="text-caption text-ink-500 group-hover:text-violet-700 font-medium mt-1 transition-colors">Automation</span>
                  </div>

                  {/* Bottom Center: Delivery */}
                  <div className="absolute left-1/2 top-[82%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-10 group cursor-pointer">
                    ...
                    <span className="text-caption text-ink-500 group-hover:text-brand-900 font-medium mt-1 transition-colors">Delivery</span>
                  </div>

                  {/* Bottom Right: Decision */}
                  <div className="absolute left-[84%] top-[82%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-10 group cursor-pointer">
                    ...
                    <span className="text-caption text-ink-500 group-hover:text-teal-700 font-medium mt-1 transition-colors">Decision</span>
                  </div>
...
function UserAvatar1() {
  return (
    <svg viewBox="0 0 40 40" className="w-full h-full" fill="none">
      ...
      <path d="M7 36 C8 26, 32 26, 33 36 Z" fill="#334155" />
    </svg>
  )
}
...
function UserAvatar2() {
  return (
    <svg viewBox="0 0 40 40" className="w-full h-full" fill="none">
      ...
      <circle cx="20" cy="15" r="7" fill="#0D9488" />
      <path d="M7 36 C8 26, 32 26, 33 36 Z" fill="#115E59" />
    </svg>
  )
}
...
function UserAvatar3() {
  return (
    <svg viewBox="0 0 40 40" className="w-full h-full" fill="none">
      ...
      <path d="M7 36 C8 26, 32 26, 33 36 Z" fill="#5B21B6" />
    </svg>
  )
}
...
function UserAvatar4() {
  return (
    <svg viewBox="0 0 40 40" className="w-full h-full" fill="none">
      ...
      <path d="M7 36 C8 26, 32 26, 33 36 Z" fill="#92400E" />
    </svg>
  )
}
...
function PodAvatar1() {
  return (
    <svg viewBox="0 0 32 32" className="w-full h-full" fill="none">
      ...
      <path d="M5 30 C6 22, 26 22, 27 30 Z" fill="#1E40AF" />
    </svg>
  )
}
...
function PodAvatar2() {
  return (
    <svg viewBox="0 0 32 32" className="w-full h-full" fill="none">
      ...
      <circle cx="16" cy="12" r="6" fill="#4F46E5" />
      <path d="M5 30 C6 22, 26 22, 27 30 Z" fill="#3730A3" />
    </svg>
  )
}
...
function PodAvatar3() {
  return (
    <svg viewBox="0 0 32 32" className="w-full h-full" fill="none">
      ...
      <circle cx="16" cy="12" r="6" fill="#DB2777" />
      <path d="M5 30 C6 22, 26 22, 27 30 Z" fill="#9D174D" />
    </svg>
  )
}
